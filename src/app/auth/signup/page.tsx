  ...
  const onSubmit = async (data: UserSignupForm) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          router.push(
            `/auth/verifyotp?email=${encodeURIComponent(data.email)}`
          );
        }, 900);
          ...
          <div className="flex gap-2.5 mb-5">
            ...
            >
              <svg className="w-4 h-4" viewBox="0 0 48 48">
                <path
                  fill="#EA4335"
                  d="M24 9.5c3.54 0 6.73 1.22 9.24 3.6l6.9-6.9C35.9 2.54 30.37 0 24 0 14.64 0 6.6 5.48 2.56 13.44l8.04 6.24C12.34 13.36 17.7 9.5 24 9.5z"
                />
                <path
                  fill="#4285F4"
                  d="M46.5 24c0-1.64-.15-3.22-.42-4.73H24v9.02h12.7c-.55 2.96-2.22 5.47-4.73 7.16l7.32 5.68C43.98 36.98 46.5 30.98 46.5 24z"
                />
                <path
                  fill="#FBBC05"
                  d="M10.6 28.68A14.5 14.5 0 0 1 9.5 24c0-1.63.28-3.2.78-4.68l-8.04-6.24A23.93 23.93 0 0 0 0 24c0 3.87.92 7.53 2.56 10.56l8.04-5.88z"
                />
                <path
                  fill="#34A853"
                  d="M24 48c6.48 0 11.92-2.13 15.89-5.78l-7.32-5.68c-2.03 1.36-4.64 2.16-8.57 2.16-6.3 0-11.66-3.86-13.4-9.18l-8.04 5.88C6.6 42.52 14.64 48 24 48z"
                />
              </svg>
              Google
            </button>
            ...
            <button
              ...
              disabled={loading}
              className="flex-1 flex items-center justify-center gap-2 py-2 px-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-xs font-medium text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
            >
